    ...
    try {
      ...
      if (data.quotes.length > 0) {
        ...
        holder.style.cssText =
          'position:fixed;left:-10000px;top:0;width:8.5in;background:#ffffff;';
        ...
        try {
          for (let i = 0; i < data.quotes.length; i++) {
            ...
            setMessage(`Rendering quote PDFs… (${i + 1} of ${data.quotes.length})`);
      ...
      if (data.projectFiles.length > 0) {
        ...
        for (let i = 0; i < data.projectFiles.length; i++) {
          ...
          setMessage(`Adding project files… (${i + 1} of ${data.projectFiles.length})`);
